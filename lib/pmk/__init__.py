...
class PMK(object):
    ...
    def __init__(self, hardware):
        ...
        # generate the numbers for the keys in the correct order
        rotated = [3, 7, 11, 15, 2, 6, 10, 14, 1, 5, 9, 13, 0, 4, 8, 12]

        for i in range(self.hardware.num_keys()):
            _key = Key(rotated[i], self.hardware)
    ...
    #     print(f"Rotating Keybow by {degrees} degrees")
    #     print(self.keys)
    ...
    #     print(flat_matrix)
    #     print(sorted(self.keys, key=lambda x:x.number))
